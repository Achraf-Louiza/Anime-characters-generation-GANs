...
class DCGAN(keras.Model):
    ...
    def __init__(self, discriminator=None, generator=None, latent_dim=16, **kwargs):
        '''
    ...
    def compile(self, 
        ...
        self.discriminator.compile(optimizer=discriminator_optimizer, loss=loss_function, metrics = ["accuracy"])
        ...
        self.d_accuracy_metric = keras.metrics.Accuracy(name="d_accuracy")
        self.g_accuracy_metric = keras.metrics.Accuracy(name="g_accuracy")

    @property
    def metrics(self):
        return [self.d_loss_metric, self.g_loss_metric, self.d_accuracy_metric,  self.g_accuracy_metric]
    ...
    def train_step(self, inputs):
        ...
        # Creation of labels corresponding to real or fake images: 0 is generated, 1 is real
        ...
        self.g_accuracy_metric.update_state(misleading_labels, tf.where(g_predictions > 0.5, 1, 0))
        self.d_accuracy_metric.update_state(labels, tf.where(d_predictions > 0.5, 1, 0))
